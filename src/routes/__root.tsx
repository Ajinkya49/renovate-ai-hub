...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "RenovationOS — AI renovation estimates" },
      { property: "og:description", content: "Upload room photos. Get instant cost ranges, timelines, and matched contractors." },
